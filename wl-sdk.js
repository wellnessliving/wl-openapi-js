 ...
 * Spec version: 1.1.20260904063327
...
})(this, function()
{
   ...
   * @type {string}
   */
  WlClient.CHANNEL = 'dev';

  /**
   * OpenAPI spec version this SDK was generated from.
   * @type {string}
   */
  WlClient.SPEC_VERSION = '1.1.20260904063327';
   ...
   *
   * When {@link WlClient#wlLocationLocation} is omitted, creates a new location requiring {@link WlClient#wlLocationLocation},
   *  {@link WlClient#wlLocationLocation}, and {@link WlClient#wlLocationLocation}.
   * When {@link WlClient#wlLocationLocation} is provided, updates only the supplied fields of the existing location.
   ...
   * @param {string} params.k_id The image ID set in {@link WlClient#coreDriveImageUploadImageUploadGet}.
   ...
   * @returns {Promise<Object>} Response data.
   */
  WlClient.prototype.wlBillingBulkBulkBillingDelete = function(params)
  {
    return this.request('/Wl/Billing/Bulk/BulkBilling.json', params || {}, 'DELETE');
  };
   ...
   * @param {Object} [params] Request body fields.
   * @returns {Promise<Object>} Response data.
   *  `k_purchase_batch` {string} The purchase batch key.
   */
  WlClient.prototype.wlBillingBulkBulkBillingPost = function(params)
  {
   ...
   * @returns {Promise<Object>} Response data.
   */
  WlClient.prototype.wlBillingBulkBulkBillingPut = function(params)
  {
    return this.request('/Wl/Billing/Bulk/BulkBilling.json', params || {}, 'PUT');
  };
   ...
   * @param {Object} [params] Request parameters.
   * @param {string} params.k_business The business key.
   * @param {string} params.k_purchase_batch The purchase batch key.
   * @param {string} params.uid The user key of the client to remove from the batch.
   * @returns {Promise<Object>} Response data.
   */
   ...
   *  `i_session_all` {number} Total number of sessions.
   ...
   *  are returned in {@link WlClient#wlAppointmentBookAssetAssetList}. Supports both frontend and backend modes.
   *
   * @param {Object} [params] Request parameters.
  ...
  /**
   * Retrieves all reward boards for business specified in {@link WlClient#wlRewardBoardBoardListList}.
   *
